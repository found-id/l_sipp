                    ...
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <select id="sortSelect" class="text-sm border border-gray-300 rounded px-2 py-1">
                                ...
                                <option value="nim_asc" {{ request('sort') == 'nim_asc' ? 'selected' : '' }}>NIM A-Z</option>
                                <option value="nim_desc" {{ request('sort') == 'nim_desc' ? 'selected' : '' }}>NIM Z-A</option>
                                <option value="status" {{ request('sort') == 'status' ? 'selected' : '' }}>Status Penilaian</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="mt-6 bg-white rounded-lg shadow">
                            ...
                            <div class="p-6">
                                <div class="bg-gray-50 rounded-lg p-4">
                                    ...
                                    <div class="mt-4">
                                        <button class="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg border border-gray-300 hover:bg-gray-200 transition-colors">
