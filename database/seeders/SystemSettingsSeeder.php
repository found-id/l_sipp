...
class SystemSettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        SystemSetting::setValue(
            'laporan_pkl_enabled',
            '1', // Default enabled
            'Toggle untuk mengaktifkan/menonaktifkan akses Tab Pemberkasan Akhir untuk mahasiswa'
        );
        ...
        SystemSetting::setValue(
            ...
            '1', // Default enabled
            'Toggle untuk mengaktifkan/menonaktifkan akses Tab Pemberkasan Instansi Mitra untuk mahasiswa'
        );
